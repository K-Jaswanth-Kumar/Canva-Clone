...
export const addShapeToCanvas = async (canvas, shapeType, customProps = {}) => {
  ...
  try {
    ...
    console.error("Failed adding shape to canvas", e);
    return null;
  }
};
...
export const addTextToCanvas = async (
  ...
  try {
    ...
    console.error("Failed adding text to canvas", e);
    return null;
  }
};
...
export const toggleDrawingMode = (
  ...
  try {
    ...
    console.error("Failed to toggle drawing mode", e);
    return false;
  }
};
...
export const toggleEraseMode = (
  ...
  try {
    ...
    console.error("Failed to toggle eraser mode", e);
  }
};
...
export const updateDrawingBrush = (canvas, properties = {}) => {
  ...
  try {
    ...
    console.error("Failed to update brush", e);
    return false;
  }
};
